...
The data source of choice is allrecipes.com, an extensive website repository of recipes that is also effectively a social platform for people who like to cook.  It is an unpolished grass-roots website for the everyday cook ([ref](http://www.slate.com/articles/life/food/2016/05/allrecipes_reveals_the_enormous_gap_between_foodie_culture_and_what_americans.html), [ref](http://press.allrecipes.com)) [\*since the takeover by Meredith, they have recently undergone a major commercial overhaul.]  
...
| |  |
|:---|:---|
|[Topic modeling with Latent Dirichlet Allocation](https://github.com/q0j0p/food/wiki/Topic-modeling-with-LDA) | [Recommendation system for recipes](https://github.com/q0j0p/food/wiki/Recommenders) |   
|[Topic modeling recipe ingredients using NMF](https://github.com/q0j0p/food/wiki/Topic-modeling-with-NMF)||
